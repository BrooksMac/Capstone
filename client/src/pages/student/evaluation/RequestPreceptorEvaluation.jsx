...
export const preceptorListLoader = async () => {
    const users = await fetch('http://papiris-api.onrender.com/api/users/preceptors');
...
export const evaluationRequestAction = async ({ request }) => {
    ...
    const res = await fetch('http://papiris-api.onrender.com/api/preceptor/eval');
    ...
    const response = await fetch('http://papiris-api.onrender.com/api/preceptor/eval', {
        method: 'POST',
