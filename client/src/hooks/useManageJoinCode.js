...
export const useManageJoinCode = () => {
    ...
    const getStudentCode = async (id) => {
        ...
        const response = await fetch('http://papiris-api.onrender.com/api/instructor/code/student', {
            method: 'POST',
    ...
    const getPreceptorCode = async (id) => {
        ...
        const response = await fetch('http://papiris-api.onrender.com/api/instructor/code/preceptor', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ id }),
        });
    ...
    const resetJoinCode = async (code) => {
        ...
        const response = await fetch('http://papiris-api.onrender.com/api/instructor/code/reset', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
